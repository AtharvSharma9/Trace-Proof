...
| # | File | Answers |
|---|---|---|
| 1 | `01_PRD.md` | What we are building and for whom |
| 2 | `02_TRD.md` | How it is built technically |
| 3 | `03_App_Flow.md` | Every screen, action and state |
| 4 | `04_UI_UX_Brief.md` | How it looks and feels |
| 5 | `05_Backend_Schema.md` | How data is stored and connected |
| 6 | `06_Implementation_Plan.md` | The exact build order |
...
Then build phase by phase using `06_Implementation_Plan.md`. Do not ask for the whole app in one
shot.
